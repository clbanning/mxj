...
// NOTE: This is only useful for substitutions in simple XML documents.  It does not currently support
// updating simple elements with attributes where the value is map["#text"]Value or manipulating
// the map[string]interface{} members generated by NewMapXmlSeq.
